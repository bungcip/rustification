...
impl ConversionContext {
    ...
    /// visit children node in RecordDecl (Struct/Union) and return FieldDecl nodes only
    ...
    fn visit_node(
        ...
        if expected_ty & TYPE != 0 {
            ...
            self.convert_node_as_other(untyped_context, node_id, new_id, expected_ty);
        }
    }
