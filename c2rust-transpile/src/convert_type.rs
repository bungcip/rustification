    ...
    */
    ...
    pub fn convert(
        ...
        match ctype.get_node(ctxt).kind {
            ...
            CTypeKind::Short => Ok(mk().path_ty(vec!["ffi", "c_short"])),
            CTypeKind::Int => Ok(mk().path_ty(vec!["ffi", "c_int"])),
            CTypeKind::Long => Ok(mk().path_ty(vec!["ffi", "c_long"])),
            CTypeKind::LongLong => Ok(mk().path_ty(vec!["ffi", "c_longlong"])),
            CTypeKind::UShort => Ok(mk().path_ty(vec!["ffi", "c_ushort"])),
            CTypeKind::UInt => Ok(mk().path_ty(vec!["ffi", "c_uint"])),
            CTypeKind::ULong => Ok(mk().path_ty(vec!["ffi", "c_ulong"])),
            CTypeKind::ULongLong => Ok(mk().path_ty(vec!["ffi", "c_ulonglong"])),
            CTypeKind::SChar => Ok(mk().path_ty(vec!["ffi", "c_schar"])),
