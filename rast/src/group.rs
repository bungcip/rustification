...
/// # use quote::quote;
/// #
/// use rast::{braced, token, Ident, Result, Token, Type};
/// use rast::parse::{Parse, ParseStream};
/// use rast::punctuated::Punctuated;
///
...
/// #         }
/// #     };
/// #     rast::parse2::<Struct>(input).unwrap();
/// # }
/// ```
#[macro_export]
#[cfg_attr(docsrs, doc(cfg(feature = "parsing")))]
...
/// use rast::{bracketed, token, Result, Token};
/// use rast::parse::{Parse, ParseStream};
///
...
/// #         #[repr(C, packed)]
/// #     };
/// #     rast::parse2::<OuterAttribute>(input).unwrap();
/// # }
/// ```
#[macro_export]
#[cfg_attr(docsrs, doc(cfg(feature = "parsing")))]
