...
///
/// ```
/// rast::custom_punctuation!(LeftRightArrow, <=>);
/// ```
///
...
/// use rast::parse::{Parse, ParseStream, Peek, Result};
/// use rast::punctuated::Punctuated;
/// use rast::Expr;
///
/// rast::custom_punctuation!(PathSeparator, </>);
///
/// // expr </> expr </> expr ...
/// struct PathSegments {
...
///     let _: PathSegments = rast::parse_str(input).unwrap();
/// }
/// ```
#[macro_export]
