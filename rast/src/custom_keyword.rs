...
/// not considered keywords in the `rast::token` module. Like any other
/// identifier that is not a keyword, these can be declared as custom keywords
/// by crates that need to use them as such.
///
/// ```
/// use rast::{LitBool, LitStr, Result, Token};
/// use rast::parse::{Parse, ParseStream};
///
/// mod kw {
///     rast::custom_keyword!(bool);
///     rast::custom_keyword!(str);
/// }
///
/// enum Argument {
///     Bool {
