...
/// use rast::{parse_macro_input, ItemFn};
///
...
///
///     // fn(DeriveInput) -> rast::Result<proc_macro2::TokenStream>
///     expand::my_derive(input)
///         .unwrap_or_else(rast::Error::into_compile_error)
///         .into()
/// }
/// #
/// # mod expand {
/// #     use proc_macro2::TokenStream;
/// #     use rast::{DeriveInput, Result};
/// #
...
impl Error {
    ...
    ///
    /// ```
    /// use rast::{Error, Ident, LitStr, Result, Token};
    ...
    /// #
    /// use proc_macro::TokenStream;
    /// use rast::{parse_macro_input, DeriveInput, Error};
    ///
